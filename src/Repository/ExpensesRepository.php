...
class ExpensesRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    // Custom Function
    public function findSumInsurance()
    {
        return $this->createQueryBuilder('qb')
            ->select('SUM(qb.insurance)')
            ->getQuery()
            ->getResult()
        ;
    }
    ...
    // Custom Function
    public function findSumUtility()
    {
        return $this->createQueryBuilder('qb')
            ->select('SUM(qb.utility)')
            ->getQuery()
            ->getResult()
        ;
    }
    ...
    // Custom Function
    public function findSumMaintenance()
    {
        return $this->createQueryBuilder('qb')
            ->select('SUM(qb.maintenance)')
            ->getQuery()
            ->getResult()
        ;
    }
